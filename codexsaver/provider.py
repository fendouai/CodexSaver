...
COMPRESSION_PROMPTS = {
    ...
    "full": (
        "Caveman mode. Remove politeness, filler, and explanatory text. "
        "Use short fragments, not full sentences. Keep code, commands, errors, and exact technical details. "
        "Do not greet or sign off."
    ),
    "ultra": (
        "Telegraph mode. Output only keywords and essential facts. "
        "Omit grammar and explanation. Keep code, errors, and exact identifiers."
    ),
    "wenyan": (
